          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="list" role="tabpanel">
              <div class="row">                        
                ...
                <div class="col-lg-4">
                  <label>Option</label>
                  <select class="form-control select2" name="optionAddDrop">
                ...
                <div class="col-lg-12" id="addDropAdd">
                  ...
                  <button class="btn btn-success btn-success-scan" name="add_submit" style="width:100%">
                    <span class="fa fa-check"></span> Submit Add
                  </button>
                </div>
                <div class="col-lg-12" id="addDropDrop">
                </div>
              </div>
            </div>
          </div>
...
<script src="{{ asset('assets/js/rims/addDrop/addDrop.js') }}"></script>
