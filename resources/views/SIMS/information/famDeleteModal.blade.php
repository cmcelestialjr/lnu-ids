<div class="modal-content">
    ...
    <div class="modal-body">
        <div class="card card-danger card-outline">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="center">Are you sure want to delete this??</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer justify-content-between">        
        ...
        <button type="button" class="btn btn-success btn-success-scan" id="famDeleteSubmit" data-id="{{$id}}"><span class="fa fa-check"></span> Yes</button>
    </div>
</div>
<!-- /.modal-content -->
