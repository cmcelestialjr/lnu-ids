...
<div class="modal-content" id="listUpdateModal">
    <div class="modal-header">
        <h4><span class="fa fa-edit"></span> Update Deduction</h4>
    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <label>Percent Employer</label>
                        <input type="number" class="form-control" name="percent_employer" value="{{$query->percent_employer}}">
                        <label>Ceiling</label>
                        <input type="number" class="form-control" name="ceiling" value="{{$query->ceiling}}">
