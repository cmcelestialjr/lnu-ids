        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="pill" href="#view" role="tab" aria-selected="true">Rooms</a>
              </li>
            </ul>
          </div>
          <div class="card-body">
                    ...
                    <div class="card card-info card-outline">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3">
                                    <label>Status</label>
                                    <select class="form-control select2" name="roomsStatus">
                                ...
                                <div class="col-lg-12">
                                    <button class="btn btn-primary btn-primary-scan" name="roomsNewModal" style="float:right;">
                                        <span class="fa fa-plus"></span> New Room
                                    </button><br><br>
                                    <table id="roomsTable" class="table table-bordered table-fixed"
                                                data-toggle="table"
                                                data-search="true"
                                                data-height="460"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="f2" data-sortable="true" data-align="center">Building</th>
...
<script src="{{ asset('assets/js/rims/rooms/rooms.js') }}"></script>
@endsection