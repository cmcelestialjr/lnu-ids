<div class="col-lg-4" id="selectRoom">
    <label>Room <button class="btn btn-info btn-info-scan btn-xs" id="roomView" data-id="{{$id}}"><span class="fa fa-search"></span></button></label>
    <select class="select2-rm_instructor rm_instructor1" name="room" id="roomSelect" style="width:100%">
...
<div class="col-lg-6">
    <label>Instructor <button class="btn btn-info btn-info-scan btn-xs" id="instructorView" data-id="{{$id}}"><span class="fa fa-search"></span></button></button></label>
    <select class="select2-rm_instructor rm_instructor1" name="instructor" id="instructorSelect" style="width:100%">
        <option value="TBA">TBA</option>
        @if($instructors!=NULL)
