...
<script src="{{ asset('assets/js/search/instructor.js') }}"></script>
<script src="{{ asset('assets/js/rims/schedule/schedule.js') }}"></script>
<script src="{{ asset('assets/js/rims/schedule/room.js') }}"></script>
<script src="{{ asset('assets/js/rims/schedule/instructor.js') }}"></script>
@endsection