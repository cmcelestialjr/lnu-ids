        ...
        <div class="card card-info card-outline">
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div id="instructor-div">
                                    <select class="form-control select2-success instructor-select" id="instructorModalSelect" data-id="{{$id}}">
                    ...
                    <div class="col-lg-12" id="instructorTable">
...
<script src="{{ asset('assets/js/rims/schedule/instructor_search.js') }}"></script>
<!-- /.modal-content -->
