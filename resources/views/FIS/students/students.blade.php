...
<!-- Content -->
<div class="content" id="studentsDiv">
  <!-- Container-fluid -->
  <div class="container-fluid">
      <div class="row">
          <div class="col-lg-12">
...
<script src="{{ asset('assets/js/fis/students/_function.js') }}"></script>
<script src="{{ asset('assets/js/fis/students/view.js') }}"></script>
<script src="{{ asset('assets/js/fis/students/modal.js') }}"></script>
<script src="{{ asset('assets/js/fis/students/new.js') }}"></script>
<script src="{{ asset('assets/js/fis/students/update.js') }}"></script>
<script src="{{ asset('assets/js/fis/students/delete.js') }}"></script>
@endsection