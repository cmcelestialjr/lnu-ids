...
<div class="modal-content" id="devicesEditModalForm">
    <div class="modal-header">
        <h4><span class="fa fa-plus"></span> Edit Device</h4>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-lg-12">
                ...
                <label>Remarks</label>
                <textarea class="form-control" name="remarks">{{$device->remarks}}</textarea>
